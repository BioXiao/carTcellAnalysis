...
To simplify the plots (and make it easier to distinguish between libraries), below I've just shown the fit line of coverage for each library.
...
```{r p89_all_segments_quant, fig.height=9, cache=TRUE}
gene_list <-c("CAR", 
