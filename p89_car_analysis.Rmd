...
plot_coverage <- function(formatted_cov_dat, gtf_dat, 
                          split = TRUE, fits_only = FALSE, color_by = "lib_num",
                          hide_legend = FALSE) {
...
p89_c1_cov_dat %>% 
    plot_coverage(car_dat, fits_only = TRUE, split = FALSE, 
                  color_by = "median_cv_coverage")
```

```{r p89_cov_jxn, fig.height=6}
p89_c1_cov_dat %>% 
    mutate(has_jxn = ifelse(tra_pos | trb_pos, 1, 0)) %>%
    plot_coverage(car_dat, fits_only = TRUE, split = FALSE, color_by = "has_jxn")
```
...
p89_c1_cov_dat %>% 
    ...
    plot_coverage(car_dat, fits_only = TRUE, split = FALSE, color_by = "has_tcr")
```
